...
function LoginPage() {
    ...
    return (
      <div className="bg-grid-pattern font-display min-h-screen flex items-center justify-center">
        <main className="w-full max-w-[1200px] min-h-[720px] flex overflow-hidden rounded-2xl shadow-2xl m-4 bg-white dark:bg-backgroundDark border border-primary/20">
          <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 auth-gradient text-white relative">
            <div className="relative z-10">
              ...
              <p className="text-lg text-white/80 max-w-md leading-relaxed">
                Készülj fel sikeresen az érettségire velünk. Minden tananyag és
                teszt egy helyen, hogy a legtöbbet hozd ki magadból.
              </p>
            </div>
            ...
            <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-primaryLight/30 rounded-full blur-3xl"></div>
          </div>

          <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 md:px-24 py-12 bg-white dark:bg-backgroundDark">
              ...
              <form id="auth-form" className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-primary/50">alternate_email</span>
                    <input
                      id="email"
                      name="email"
                      type="email"
                ...
                <div id="password-container">
                  ...
                  <div className="relative">
                    <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-primary/50">lock</span>
                    <input
                      id="password"
                      name="password"
                      type="password"
